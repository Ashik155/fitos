...
export const metadata: Metadata = {
  title: 'FitOS — Your AI Fitness Command Centre',
  description:
    'Personalised nutrition plans, AI training programmes, and progress roadmaps grounded in evidence-based science.',
  icons: {
    icon: '/favicon.svg',
  },
};
...
export default function RootLayout({
  ...
  return (
    <html lang="en">
      <head>
        {/* Clash Display — page titles, big numbers */}
        <link
